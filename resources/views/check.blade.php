        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    ...
                    <img src="{{asset('adminAssets/images/logo-full.png')}}" alt="" class="logo logo-lg">
                    <img src="{{asset('adminAssets/images/logo-abbr.png')}}" alt="" class="logo logo-sm">
                </a>
            </div>
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            <div class="mb-4 rounded-3 border">
                                                <img src="{{asset('adminAssets/images/banner/mockup.png')}}" alt="" class="img-fluid rounded-3">
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{asset('adminAssets/images/general/full-avatar.png')}}" alt="" class="img-fluid full-user-avtar">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-lg-flex align-items-center justify-content-between">
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="mailto:theme_ocean@example.com" class="fs-13 fw-bold text-primary">Contact Us &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/app-store.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/spotify.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/figma.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/shopify.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/paypal.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/gmail.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/dropbox.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/google-drive.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/github.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/gitlab.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/facebook.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/pinterest.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/instagram.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/twitter.png')}}" alt="" class="img-fluid">
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{asset('adminAssets/images/brand/youtube.png')}}" alt="" class="img-fluid">
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{asset('adminAssets/images/banner/1.jpg')}}" alt="" class="img-fluid">
                                                    </div>
                                                    <div class="mt-4">
                                                        <a href="mailto:theme_ocean@example.com" class="fs-13 fw-bold">View all resources on Duralux &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div id="carouselResourcesCaptions" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner rounded-3">
                                                            <div class="carousel-item active">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/6.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/5.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/4.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/3.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/2.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{asset('adminAssets/images/banner/1.jpg')}}" alt="" class="img-fluid d-block w-100">
                                                                </div>
                                                                <div class="carousel-caption">
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/1.jpg')}}" alt="" class="img-fluid rounded-3">
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{asset('adminAssets/images/avatar/1.png')}}" alt="" class="img-fluid">
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/2.jpg')}}" alt="" class="img-fluid rounded-3">
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{asset('adminAssets/images/avatar/2.png')}}" alt="" class="img-fluid">
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/3.jpg')}}" alt="" class="img-fluid rounded-3">
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{asset('adminAssets/images/avatar/3.png')}}" alt="" class="img-fluid">
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/4.jpg')}}" alt="" class="img-fluid rounded-3">
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{asset('adminAssets/images/avatar/4.png')}}" alt="" class="img-fluid">
                                                                                </div>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="mailto:theme_ocean@example.com" class="fs-13 fw-bold">View all features on Duralux &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/1.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/2.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/3.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/4.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/5.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{asset('adminAssets/images/banner/6.jpg')}}" alt="" class="img-fluid rounded-3 border border-3">
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="{{asset('adminAssets/images/avatar/5.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{asset('adminAssets/images/file-icons/css.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{asset('adminAssets/images/file-icons/zip.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{asset('adminAssets/images/file-icons/pdf.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <img src="{{asset('adminAssets/vendors/img/flags/4x3/us.svg')}}" alt="" class="img-fluid wd-20">
                        </a>
                                ...
                                <div class="row px-4 pt-3">
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/sa.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Arabic</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/bd.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Bengali</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/ch.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Chinese</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/nl.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Dutch</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select active">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/us.svg')}}" alt="" class="img-fluid"></div>
                                            <span>English</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/fr.svg')}}" alt="" class="img-fluid"></div>
                                            <span>French</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/de.svg')}}" alt="" class="img-fluid"></div>
                                            <span>German</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/in.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Hindi</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/ru.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Russian</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/es.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Spanish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/tr.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Turkish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{asset('adminAssets/vendors/img/flags/1x1/pk.svg')}}" alt="" class="img-fluid"></div>
                                            <span>Urdo</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="{{asset('adminAssets/images/avatar/2.png')}}" alt="" class="rounded me-3 border">
                            ...
                            <div class="notifications-item">
                                <img src="{{asset('adminAssets/images/avatar/3.png')}}" alt="" class="rounded me-3 border">
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="{{asset('adminAssets/images/avatar/4.png')}}" alt="" class="rounded me-3 border">
                                <div class="notifications-desc">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{asset('adminAssets/images/avatar/1.png')}}" alt="user-image" class="img-fluid user-avtar me-0">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAssets/images/avatar/1.png')}}" alt="user-image" class="img-fluid user-avtar">
                                    <div>
    ...
    <div class="col-xl-8">
      <div class="card invoice-container">
        <div class="card-header">
          <h5>Add Base Product (Blank)</h5>
          <small class="text-muted d-block">
            Admin catalog item (no design). Designers will apply artwork later in InkForge Studio.
          </small>
        </div>
...
@enderror
                  ...
                  <div class="col-12">
                    <div class="form-group mb-3">
                      ...
                      <textarea rows="5" class="form-control" name="description"
                                placeholder="Product details, material, fit, wash care..."></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group mb-3">
                      ...
                      <input type="number" class="form-control" name="weight_grams" min="0" value="0">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" name="print_area_width" min="0" placeholder="e.g. 300">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group mb-3">
                            <label class="form-label">Print Area Height</label>
                            <input type="number" class="form-control" name="print_area_height" min="0" placeholder="e.g. 400">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group mb-3">
                            <label class="form-label">Min DPI</label>
                            <input type="number" class="form-control" name="min_dpi" min="72" value="150">
                        ...
                        <div class="col-md-6">
                          <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="mockup_template" placeholder="template file name / path">
                            <div class="fs-12 text-muted mt-1">
  Admin-only. Used for mockup generation presets.
</div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="tab-pane fade" id="tab_variants">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered" id="variantsTable">
                    ...
                    <tbody>
                      <tr>
                        <td><input class="form-control" name="variants[0][sku]" placeholder="TSHIRT-BLK-M" required></td>
                        <td><input class="form-control" name="variants[0][color_name]" placeholder="Black"></td>
                        <td><input class="form-control" name="variants[0][color_hex]" placeholder="#000000"></td>
                        <td><input class="form-control" name="variants[0][size]" placeholder="M"></td>
                        <td><input class="form-control" name="variants[0][stock_count]" type="number" placeholder="-1"></td>
                        <td><input class="form-control" name="variants[0][additional_cost]" type="number" step="0.01" placeholder="0.00"></td>
                ...
                <div class="fs-12 text-muted mt-2">
                  Tip: Stock -1 means “unlimited / managed externally”.
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="tab_images">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered" id="imagesTable">
                    ...
                    <tbody>
                      <tr>
                        <td><input class="form-control" name="images[0][image_url]" placeholder="https://..." required></td>
                        <td>
                          <select class="form-control" name="images[0][image_type]">
                            <option value="mockup">mockup</option>
                            <option value="preview">preview</option>
                            <option value="lifestyle">lifestyle</option>
                          </select>
                        </td>
                        <td><input class="form-control" name="images[0][angle]" placeholder="front"></td>
                        <td><input class="form-control" name="images[0][alt_text]" placeholder="Front mockup"></td>
                        <td class="text-center">
                          <button type="button" class="btn btn-sm bg-soft-danger text-danger removeRow">Remove</button>
                        </td>
                      </tr>
              ...
              <div class="tab-pane fade" id="tab_attrs">
                  ...
                  @foreach($attributes as $i => $a)
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="attrs[{{ $i }}][value]" placeholder="Enter {{ strtolower($a->name) }}">
                      </div>
                    </div>
                  @endforeach
                </div>
                ...
                <div class="form-group mb-3">
                  ...
                  <select class="form-control" name="tag_ids[]" multiple>
                    @foreach($tags as $t)
                      <option value="{{ $t->id }}">{{ strtoupper($t->type) }} — {{ $t->name }}</option>
                    @endforeach
                  </select>
