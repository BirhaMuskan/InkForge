...
<!--! ================================================================ !-->
            ...
            <div class="main-content">
                <div class="row">
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Orders Placed</h3>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Orders in Production</h3>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-3">
                                        <div class="p-3 border border-dashed rounded">
                                            <div class="fs-12 text-muted mb-1">Liability</div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="p-3 border border-dashed rounded">
                                            <div class="fs-12 text-muted mb-1">Assets</div>
                        ...
                        <div class="card stretch stretch-full overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{asset('adminAssets/images/brand/shopify.png')}}" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{asset('adminAssets/images/brand/app-store.png')}}" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{asset('adminAssets/images/brand/figma.png')}}" alt="" />
                                        </div>
                                        <div>
                        ...
                        <div class="card mb-4 stretch stretch-full">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-semibold text-dark">Total payouts processed</div>
                        ...
                        <div class="card mb-4 stretch stretch-full">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-semibold text-dark">Pending payouts to designers</div>
                    ...
                    <div class="col-xxl-4">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Product's Popularity Overview</h5>
                                <div class="card-header-action">
                                    <div class="card-header-btn">
                                        <div data-bs-toggle="tooltip" title="Delete">
                                            <a href="javascript:void(0);" class="avatar-text avatar-xs bg-danger" data-bs-toggle="remove"> </a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{asset('adminAssets/images/avatar/6.png')}}" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                ...
                                <div class="p-3 border border-dashed rounded-3 mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                            ...
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{asset('adminAssets/images/avatar/5.png')}}" class="img-fluid" alt="image" />
                                            </a>
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{asset('adminAssets/images/avatar/6.png')}}" class="img-fluid" alt="image" />
                                            </a>
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{asset('adminAssets/images/brand/app-store.png')}}" alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{asset('adminAssets/images/brand/figma.png')}}" alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{asset('adminAssets/images/brand/facebook.png')}}" alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{asset('adminAssets/images/brand/github.png')}}" alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{asset('adminAssets/images/brand/paypal.png')}}" alt="sketch-logo" class="me-3" width="35" />
                                            <div>
    ...
    <script src="{{asset('adminAssets/vendors/js/daterangepicker.min.js')}}"></script>
    <script src="{{asset('adminAssets/vendors/js/apexcharts.min.js')}}"></script>
    <script src="{{asset('adminAssets/vendors/js/circle-progress.min.js')}}"></script>
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
    <script src="{{asset('adminAssets/js/common-init.min.js')}}"></script>
    <script src="{{asset('adminAssets/js/dashboard-init.min.js')}}"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
